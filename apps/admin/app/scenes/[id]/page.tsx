...
export default function SceneDetailPage() {
  ...
  return (
    <AppShell
      ...
      rightRail={rightRail}
      breadcrumb={{ label: "场景管理", childLabel: editing ? "编辑场景" : "场景详情" }}
    >
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            <div style={{
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <button className="btn primary" type="button" onClick={() => { initFormFromDetail(detail); setEditing(true); }}>
                  <Edit size={16} /> 编辑
                </button>
              </div>
            </div>
        ...
        <div className="page-section">
          <div className="card" style={{ padding: 0, overflow: "hidden" }}>
            ...
            <div style={{
              ...
              <button className="btn" type="button" onClick={() => setEditing(false)} disabled={submitting}>
                取消
              </button>
              <button className="btn primary" type="button" disabled={submitting} onClick={handleSave}>
                <Save size={16} /> 保存
